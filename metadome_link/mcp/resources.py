...
METADOME_SERVER_INSTRUCTIONS = (
    ...
    "Data are served from the configured MetaDome build (GRCh37.p13 or GRCh38.p14); "
    "responses identify the exact build and component versions.\n"
    "\n"
    "Canonical workflow:\n"
    ...
    "(prefers an analyzable MANE Select transcript; otherwise falls back to the "
    "longest analyzable protein-coding transcript).\n"
    ...
    "\n"
    "Data-currency caveat: both supported MetaDome profiles are historical; every "
    "response identifies its exact component versions in _meta.data_versions. "
...
METADOME_USAGE_NOTES = (
    ...
    "Data are pinned to the configured MetaDome 2.0 build; use live gnomAD/ClinVar "
...
METADOME_REFERENCE_NOTES = (
    ...
    "MetaDome profiles are historical; inspect _meta.data_versions for the exact "
    "configured build and component snapshot. "
    f"{METADOME_LICENSE}"
)
